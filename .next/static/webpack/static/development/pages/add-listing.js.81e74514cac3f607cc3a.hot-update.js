...
var ImagePicker = function ImagePicker() {
  ...
  var deleteImage = function deleteImage(e) {
    console.log(e.target); // const id = parseInt(e.target.parentNode.id.slice(-1));
    // images.splice(id, 1);
    // chooseImages(images);
  };
...
//# sourceMappingURL=add-listing.js.81e74514cac3f607cc3a.hot-update.js.map