...
var Listings = function Listings(_ref) {
  ...
  var userListings, othersListings;
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])('abgfigu143668'),
      testUser = _useState3[0];

  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    for (var user in users) {
      if (user === testUser) {
        userListings = listings[testUser].listings;
        changeListing(userListings);
      } else {
        othersListings = listings[user].listings;
        changeListing(othersListings);
      }
...
//# sourceMappingURL=listings.js.7921cf08938d3e62be2b.hot-update.js.map